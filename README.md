...
Curious about the magic that just happened? Dive deeper and explore **MrBiomics'** capabilities starting with our [**Quickstart**](../../wiki/Quickstart)!
...
- [Datlinger, Pankevich, Arnold et al. (2025) Nature - Systematic discovery of CRISPR-boosted CAR T cell immunotherapies](https://www.nature.com/articles/s41586-025-09507-9) [![NGS Processing](https://img.shields.io/badge/NGS%20processing-red)](https://github.com/epigen/spilterlize_integrate) [![DEA limma](https://img.shields.io/badge/DEA%20limma-red)](https://github.com/epigen/dea_limma/) [![Enrichment Analysis](https://img.shields.io/badge/Enrichment%20Analysis-red)](https://github.com/epigen/enrichment_analysis/)
- [Haladik et al. (2025) Cell Reports Medicine - Image-based drug screening combined with molecular profiling identifies signatures and drivers of therapy resistance in pediatric AML](https://www.cell.com/cell-reports-medicine/fulltext/S2666-3791(25)00377-5) [![ATAC-seq](https://img.shields.io/badge/ATAC%E2%80%90seq-red)](https://github.com/epigen/atacseq_pipeline/)
...
- [Troester et al. (2025) Nature Communications - Transcriptional and epigenetic rewiring by the NUP98::KDM5A fusion oncoprotein directly activates CDK12](https://doi.org/10.1038/s41467-025-59930-9) [![ATAC-seq](https://img.shields.io/badge/ATAC%E2%80%90seq-red)](https://github.com/epigen/atacseq_pipeline/)
